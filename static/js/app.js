...
const blockSize =
    document.getElementById("blockSize");

const blockSizeValue =
    document.getElementById("blockSizeValue");

const cValue =
    document.getElementById("cValue");

const cText =
    document.getElementById("cText");

const adaptiveMethod =
    document.getElementById("adaptiveMethod");
...
const otsuValue =
    document.getElementById("otsuValue");


const resultThreshold =
    document.getElementById("resultThreshold");

const blackPct =
    document.getElementById("blackPct");

const whitePct =
    document.getElementById("whitePct");

const processTime =
    document.getElementById("processTime");
...
const otsuPanel =
    document.getElementById("otsuPanel");

const adaptivePanel =
    document.getElementById("adaptivePanel");
...
blockSize.addEventListener(
    "input",
    () => {

        blockSizeValue.textContent =
            blockSize.value;
...
async function processImage() {
    ...
    try {
        ...
        resultImage.src =
            `/outputs/${result.output}?t=${Date.now()}`;
        ...
        otsuValue.textContent =
            result.threshold ?? "--";


        blackPct.textContent =
            result.stats.black_pct + "%";


        whitePct.textContent =
            result.stats.white_pct + "%";
